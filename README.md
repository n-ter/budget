...
(могут понадобиться права администратора sudo)

1. npm install -g create-react-app
2. create-react-app react-budget-v1
3. cd react-budget-v1
4. npm add lodash moment styled-components (в папке с проектом)
запуск:
5. npm start (из папки с проектом)
